...
struct UserGetCollectShopsData: Gloss.JSONDecodable {
    var shopId: Int?
    var stampCount: Int? //单轮次的集章数目，目前暂无使用地方
    var totalStampCount: Int? //目前已集的章数
    var nextStampCount: Int? //下次领奖需要集的章数
    var minStampRules: String?
    var minStampCount: Int? //单轮次的最小集章数，目前暂无使用地方
    var maxStampCount: Int? //单轮次的最大集章数，目前暂无使用地方
    var name: String?
    var address: String?
    var typeId: Int?
    var signUrl: String?
